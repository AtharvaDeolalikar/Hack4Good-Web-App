    ...
    <Dialog open={open}>
      ...
      <DialogContent>
        ...
        <DialogContentText>
          <Stack spacing={1}>
            <li>
              You can obtain the problem statement ID by clicking{" "}
              <Link
                href="https://drive.google.com/file/d/1TzF-xabb0Y4luc7VqnZAm_zjZ6EpLJvx/view?usp=sharing"
                target="_blank"
              >
                here
              </Link>
            ...
            <li>
              You can also select different problem statement (Out of Box) by
              entering the problem statement ID as "PS-7"
            </li>
            <li>
        ...
        <Button onClick={close} sx={{ float: "right" }}>
          Close
        </Button>
      </DialogContent>
    </Dialog>
